    ...
    public class PersonagensController : ControllerBase
    {
        ...
        public async Task<IActionResult> Add(Personagem novoPersonagem)
        {
            try
            {
                ...
                if (novoPersonagem.Forca < 30 || novoPersonagem.Forca > 35)
                    throw new System.Exception("Força deve estar entre 30 e 35");
                if (novoPersonagem.Defesa < 30 || novoPersonagem.Defesa > 35)
                    throw new System.Exception("Defesa deve estar entre 30 e 35");
                if (novoPersonagem.Inteligencia < 30 || novoPersonagem.Inteligencia > 35)
                    throw new System.Exception("Defesa deve estar entre 30 e 35");

                if (novoPersonagem.Usuario != null)
                    novoPersonagem.Usuario = _context.Usuarios.FirstOrDefault(uBusca => uBusca.Id == novoPersonagem.Usuario.Id);
